  ...
  return (
    <section id="contact" className="py-20 bg-black relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center max-w-3xl mx-auto space-y-6 rounded-2xl border border-white/10 bg-white/[0.03] p-8 md:p-10 shadow-[0_18px_44px_rgba(0,0,0,0.34)]">
          <p className="text-xs uppercase tracking-[0.18em] text-indigo-300">Final step</p>
